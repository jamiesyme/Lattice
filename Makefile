...
MINFO_SOURCES=src/minfo.c src/audio-module.c src/date-module.c src/graphics.c src/hub.c src/module-list.c src/radio-receiver.c src/radio-transmitter.c src/surface.c src/time-module.c src/time-utils.c
