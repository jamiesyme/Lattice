...
MINFO_SOURCES=src/minfo.c src/audio-module.c src/date-module.c src/frame-limiter.c src/graphics.c src/hub.c src/radio.c src/surface.c src/time-module.c
