...
MINFO_SOURCES=src/minfo.c src/audio-module.c src/date-module.c src/frame-limiter.c src/graphics.c src/hub.c src/module-list.c src/radio.c src/surface.c src/time-module.c

MINFO_MSG_CFLAGS=-Wall
MINFO_MSG_LDFLAGS=
MINFO_MSG_SOURCES=src/minfo-msg.c src/radio.c
