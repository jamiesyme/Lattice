...
LATTICE_SOURCES=src/lattice.c src/audio-module.c src/command-utils.c src/date-module.c src/draw-utils.c src/fps-limiter.c src/hub.c src/interpolation-utils.c src/json.c src/module.c src/module-director.c src/module-renderer.c src/module-type.c src/radio.c src/surface.c src/time-module.c src/time-utils.c src/workspace-module.c
